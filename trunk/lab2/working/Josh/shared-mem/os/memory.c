...
extern uint32 SHM_Array_Shmids[MEM_L1_PAGE_TABLE_SIZE];
extern int SHM_Array_ProcessCount[MEM_L1_PAGE_TABLE_SIZE];
...
void MemoryModuleInit() {
  ...
  ///////////////////////////////////
  //YF Added initialize array for sharing
  for( s=0; s<SHMALL;s++ )
  {
  	SHM_Array_Shmids[s]=0;
  	SHM_Array_ProcessCount[s]=0;
  }
