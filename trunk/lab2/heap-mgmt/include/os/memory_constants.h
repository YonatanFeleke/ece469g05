...
// JSM -- not needed? #define MEM_MAX_HEAP_POINTER_ARRAY (MEM_PAGE_SIZE-1)/32 //=128 ONLY word addressed
// JSM -- not needed? #define MEM_PTE_HEAP 0x8 //To distinguish weather this is a correct location in heap or not
// JSM -- not needed? #define MEM_WORD_ADRESS_MASK 0xFE0// MASK OF LOWER TWO BITS
