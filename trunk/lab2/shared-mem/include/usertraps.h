...
unsigned int shmget(int shmsize);	//trap 0x440
void *shmat(unsigned int shmid, int vaddr);	//trap 0x441
int shmdt(void *shmaddr);					//trap 0x442
int shmrm(int shmid);							//trap 0x443
