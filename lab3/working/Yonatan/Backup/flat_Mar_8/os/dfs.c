...
int DfsWriteBlock(uint32 blocknum, dfs_block *b)
{
	...
	{
		dbprintf('C',"DfsWriteBlock: Block #%d is not cached!\n",blocknum);
	...
	{
		dbprintf('C',"DfsWriteBlock: Block #%d ",blocknum);
...
int DfsCacheHit(int blocknum)
{
	...
	for (i=0; i< full_slots.nitems; i++)
	{
		...
		entry= (dfs_buffer_block *) tmp->object; //TODO Check if possible
