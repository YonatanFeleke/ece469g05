...
#define MEM_PAGE_SIZE (0x1 << MEM_L2FIELD_FIRST_BITNUM) //MAY CAUSE ISSUES WITH L2
...
//Memory_sharing
#define SHMMAX MEM_PAGE_SIZE						//4k
#define SHMMIN MEM_PAGE_SIZE						//4k
#define SHMALL MEM_L1_PAGE_TABLE_SIZE 	//512
#define SHMERROR -1
